...
app.get('/account', async function (req, res) {
    ...
    let customer = await UserService.getUserById(objectID).exec();
    console.log("in account customer", customer)
    // if (!customer) {
    //   res.redirect('/')
    // } else {
    ...
    //   )
    // }
    customer.then(function (doc) {console.log(doc.billingID)});
    console.log("in account customer info", customer)
    console.log("customer info", Object.keys( customer));
    console.log("customer info", customer.billingID);
    customerInfo = await Stripe.getCustomerByID(customer.session.billingID)
